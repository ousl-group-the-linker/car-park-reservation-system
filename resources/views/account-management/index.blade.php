...
@section('main-body')
    <div id="update-profile" class="card" style="max-width: 680px">
        ...
        <form novalidate action="{{ route('account-management.update') }}" method="post">
            @csrf
            ...
            <div class="card-body">
                ...
                <div class="mb-3">
                    ...
                    <select class="form-select mt-2  @if ($errors->profileUpdate->has('address_city')) is-invalid @endif" aria-label="City"
                        name="address_city">
            ...
            <div class="card-footer d-flex justify-content-end">
                <a href="{{ route('account-management') }}" class="btn btn-light me-2">Reset</a>
            ...
            <div class="card-body">
                ...
                <div class="mb-3">
                    ...
                    <input type="password" class="form-control @if ($errors->changePasswordBag->has('current_password')) is-invalid @endif"
                        id="current_password" name="current_password" placeholder="Type your current password here..."
                        required>
