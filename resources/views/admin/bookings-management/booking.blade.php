...
@section('main-body')
    <div class="container">
            ...
            <div class="card">
                ...
                <div class="card-footer d-flex justify-content-end d-flex justify-content-between">
                    ...
                    <div class="d-flex flex-row">
                        ...
                        @can('markAsOnGoing', $booking)
                            <button class="btn btn-success ms-2" data-bs-toggle="modal" data-bs-target="#mark-as-on-going"><i
                                    class="bi bi-align-start me-2"></i>Start
                                Booking</button>
                        @endcan

                        @can('markAsFinished', $booking)
                            <button class="btn btn-primary ms-2" data-bs-toggle="modal" data-bs-target="#mark-as-finished"><i
                                    class="bi bi-align-end me-2"></i>Finish
                                Booking</button>
                        @endcan
                    </div>
                </div>
        ...
        @can('markAsOnGoing', $booking)
            <div id="mark-as-on-going" class="modal" tabindex="-1">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                        ...
                        <div class="modal-body">
                            <p>Are you sure that you want to start this booking?</p>
                        </div>
                        <div class="modal-footer">
                            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
        ...
        @can('markAsFinished', $booking)
            <div id="mark-as-finished" class="modal" tabindex="-1">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title">Finish Booking</h5>
                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>
                        <div class="modal-body">
                            <p>Are you sure that you want to finish this booking?</p>
                        </div>
                        <div class="modal-footer">
                            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
