            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item" aria-current="page">
                    <a href="{{ route('balance-and-recharge.transactions') }}"
                        class="text-decoration-none text-dark">Transactions</a>
                </li>
            </ol>
        </nav>
    </div>
                ...
                <ul class="nav nav-pills">
                    <li class="nav-item">
                        <a class="nav-link active bg-main text-light" aria-current="page"
                            href="{{ route('balance-and-recharge.transactions') }}"><i
                                class="bi bi-arrow-left-right me-2"></i>Transactions</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link text-dark" href="{{ route('balance-and-recharge.holds') }}"><i
                                class="bi bi-pause-circle me-2"></i>Holds</a>
                    </li>
                </ul>
            </div>
        </div>
