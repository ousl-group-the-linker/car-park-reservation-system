...
class AccountManagementTest extends TestCase
{
    ...
    public function testIsProfileUpdateSavingWrong(){
        $email =  time() . "kae@mail.com";
        $password="1234567890";
    ...
    public function testIsPasswordUpdatesCorrectly()
    {
        ...
        $response = $this->post(route("account-management.change-password"), [
